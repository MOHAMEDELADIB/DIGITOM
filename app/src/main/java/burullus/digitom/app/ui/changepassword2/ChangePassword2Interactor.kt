 ...
 * Interactor Class
 */
class ChangePassword2Interactor(private val presenter : ChangePassword2MvpPresenter) :
    ChangePassword2MvpInteractor {
    /**
     * Authentication function to change password
     */
    @SuppressLint("CheckResult")

    override fun changePass(new_password1 : String, new_password2 : String) {
        Repository.ChangePass(new_password1, new_password2)
            .subscribe({ (detail) ->
